...
Every MCParticle can be linked to a track with the associated track ID.
The track hierarchy can be obtained by using the parent-child relationships of all MCParticles in a given event.
If a MCParticle is linked via this relationship on one detector, the tracks can be globally linked this way as well.
