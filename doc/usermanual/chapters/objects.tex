...
These objects can be sent with the messaging system as explained in Section \ref{ch:objects_messages}.
...
All objects created during a single simulation event are accessible until the end of the event; more information on object persistency within the framework can be found in Section~\ref{ch:objects_persistency}.
