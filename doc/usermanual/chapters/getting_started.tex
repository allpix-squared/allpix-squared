...
\begin{itemize}
  \item The \parameter{position}, \parameter{orientation} and \parameter{mother_volume} of the material as described for the detector, see Section \ref{sec:detector_config}.
