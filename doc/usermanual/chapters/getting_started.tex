...
\begin{itemize}
  ...
  \item An optional string referring to the \paramater{mother_volume}, which defines the volume where the passive material will be placed in.
  Note: the position that is given will be relative to the center of the mother volume chosen. An error will be given if the specified mother volume is too small fo the passive material to fit in. Defaults to the world frame.
...
\item (Optional) The \parameter{inner_size} of the box is an XY vector which defines the size of the hole which will be removed from the original box vn{itemize}
...
olume. Defaults to 0mm 0mm.
\item (Optional) The \parameter{thickness} of the box is a value which defines the thickness of the walls of a box with a hole in the middle. This has the has the same effect as the \paramater{inner_size}, and such they can't be used together.
 Defaults to 0mm.
\end{itemize}
