...
All size paramaters that describe the total length of something are placed such that half of this total length extends from each side of the given \parameter{position}.
...
\textbf{Box}: A rectangular box which can be massive or have an inner volume.
\begin{itemize}
...
\textbf{Tube}: A rectangular tube which can be open at both ends along the z-axis.
\begin{itemize}
...
\textbf{Cylinder}: A cylindrical tube which can be open at both ends along the z-axis.
\begin{itemize}
