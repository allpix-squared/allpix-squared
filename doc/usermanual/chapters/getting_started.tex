...
\begin{itemize}
  ...
  \item An optional string referring to the \parameter{mother_volume}, which defines another passive material the volume will be placed in.
  Note: the position that is given will be relative to the center of the mother volume chosen. An error will be given if the specified mother volume is too small for the specified size or position of this volume. Defaults to the world frame.
