...
\item \textbf{\texttt{workers}}: Specify the amount of workers to use in total, should be strictly larger than zero. Only used if \texttt{experimental\_multithreading} is set to true. Defaults to the number of native threads available on the system if this can be determined.
\end{itemize}
