...
More details and a more thorough example are found in Section~\ref{sec:main_config}, several advanced simulation chain configurations are presented in Section~\ref{sec:examples}.
...
Finally, some detector histograms for the device under test (DUT) will be recorded as ROOT histograms and all simulated objects, including the entry and exit positions of the simulated Monte Carlo particles (Monte Carlo truth), will be stored in the \apsq ROOT file.
...
\subsection{Extending the Simulation Chain}
