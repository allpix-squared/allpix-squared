...
In case one or more modules do not support multi-threading, a warning is printed and the feature is disabled. Modules can inform themselves about the decision via the \texttt{multithreadingEnabled()} method.
...
Furthermore, \emph{Geant4} does not guarantee results reproducibility between its multi-threaded and sequential run managers.
