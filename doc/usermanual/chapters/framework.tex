...
\begin{description}
    ...
    \item[\command{LOG_N(LEVEL, NUMBER)}] Same as \command{LOG_ONE} but allows to specify the number of times the message will be logged via the additional parameter \parameter{NUMBER}.
    \begin{minted}[frame=single,framesep=3pt,breaklines=true,tabsize=2,linenos]{c++}
