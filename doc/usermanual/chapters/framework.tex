...
Therefore each module each module must explicitly enable multithreading in its constructor via calling the \texttt{allow_multithreading()} method in order to signal its multithreading capabilities to \apsq.
