...
\item An optional parameter \parameter{mother_volume} to specify the mother volume of the detector. The mother volume can be chosen from the passive materials defined in Section~\ref{sec:passive_material_config}.
