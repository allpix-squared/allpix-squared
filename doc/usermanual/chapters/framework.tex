...
Any text between the \texttt{$=$} and the first \texttt{\#} character not enclosed within a pair of single double quotes (\texttt{'} or \texttt{"}) is known as the non-stripped string.
