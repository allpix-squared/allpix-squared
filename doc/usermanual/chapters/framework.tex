...
Inheriting from this class will allow the module to transparently check if the given event is in order and decide whether to execute it immediately or to request buffering if it is out of order.

Using the \texttt{SequentialModule} is suitable for I/O modules which read or write to the file system.
