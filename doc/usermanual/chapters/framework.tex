...
If a module's \texttt{run()}-function access a member field
...
For this reason, it is not currently recommended to use more than 8 workers during simulation as this will greatly impact performance negatively.
