...
The \texttt{zxz} uses the extrinsic Z-X-Z convention for Euler angles instead (this option is also known as the 1-3-1 or the "x-convention" and the most widely used definition of Euler angles overall~\cite{eulerangles}).
