...
Each event holds a random engine that can be used by a moudle in it's \texttt{run()} method.
...
Furthermore, Geant4 does not guarante results reproducibility between both its multi-threaded and sequential run managers.
