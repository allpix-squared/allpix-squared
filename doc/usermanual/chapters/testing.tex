...
\begin{description}
    \item[test\_01-1\_globalconfig_detectors.conf] \todo{describe}
    \item[test\_01-2\_globalconfig_modelpaths.conf] \todo{describe}
    \item[test\_01-3\_globalconfig_log_format.conf] \todo{describe}
    \item[test\_01-4\_globalconfig_log_level.conf] \todo{describe}
    \item[test\_01-5\_globalconfig_log_file.conf] \todo{describe}
    \item[test\_01-6\_globalconfig_missing_model.conf] \todo{describe}
    \item[test\_01-7\_globalconfig_random_seed.conf] \todo{describe}
    \item[test\_01-8\_globalconfig_random_seed_core.conf] \todo{describe}
    \item[test\_02-1\_specialization_unique_name.conf] \todo{describe}
    \item[test\_02-2\_specialization_unique_type.conf] \todo{describe}
    \item[test\_03-1\_geometry_g4_coordinate_system.conf] \todo{describe}
    \item[test\_03-2\_geometry_rotations.conf] \todo{describe}
    \item[test\_03-3\_geometry_misaligned.conf] \todo{describe}
\end{description}
...
\begin{description}
    ...
    \item[test\_03-1\_deposition.conf] executes the charge carrier deposition module. This will invoke Geant4 to deposit energy in the sensitive volume. The monitored output comprises the physics list used and the exact number of charge carriers deposited in the detector.
    \item[test\_03-2\_deposition_mc.conf] \todo{describe}
    ...
    \item[test\_06-1\_digitization_charge.conf] digitizes the transferred charges to simulate the front-end electronics. The monitored output of this test comprises the total charge per pixel including noise contributions, the smeared threshold value and the total number of digitized pixel hits.
    \item[test\_06-2\_digitization_adc.conf]
    \item[test\_06-3\_digitization_gain.conf]
    ...
    \item[test\_08-4\_writer\_corryvreckan.conf]
    \item[test\_08-5\_writer\_corryvreckan_mc.conf]
