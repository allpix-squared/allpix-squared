...
It contains the ROOT6 and Geant4 paths used for the compilation of the binaries, these paths might have to be changed manually when deploying on different computers.
