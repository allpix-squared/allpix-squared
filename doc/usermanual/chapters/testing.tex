...
\begin{description}
    ...
    \item[\file{test_03-7_deposition_source_macro.conf}] tests the G4 macro source type in the charge carrier deposition module using source_macro_test.txt as input, monitoring the deposited charges.
