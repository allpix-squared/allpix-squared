...
\paragraph{\texttt{\textbf{ADD\_RUNTIME\_DEP}}}
...
\paragraph{\texttt{\textbf{ADD\_RUNTIME\_LIB}}}

This CMake command can be used to add additional libraries to the global search path.
The mandatory argument should be the absolute path of a library or a list of paths for example:
