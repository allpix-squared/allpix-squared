...
\begin{description}
    ...
    \item[\file{test_04-7_module_config_empty_filter.conf}] tests the framework behaviour with an empty filter.
    \item[\file{test_04-8_configuration_unused_key.conf}] tests the detection of unused configuration keys in the gloal configuration section.
    ...
    \item[\file{test_06-7_multithreading_physics.conf}] tests the reproducibility in case of multithreading enabled.
    \item[\file{test_06-8_multithreading_buffered.conf}] tests the reproducibility in case of a sequential module.
    \item[\file{test_06-9_multithreading_disabled.conf}] tests the framework response to explicitly disabling multithreading.
