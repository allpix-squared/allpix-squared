...
\begin{description}
    ...
    \item[\file{test_03-7_deposition_source_macro.conf}] tests the G4 macro source in the charge carrier deposition module by monitoring the deposited charges.
