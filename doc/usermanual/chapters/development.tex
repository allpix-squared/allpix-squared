...
Thereafter, the steps below should provide enough details for starting with a new module, hereafter called \parameter{ModuleName}:
\begin{enumerate}
...
\item Finally the constructor, the \parameter{init}, \parameter{run} and/or \parameter{finalize} methods can be written, depending on the requirements of the new module.
\end{enumerate}
