...
\begin{tikzpicture}[thick]
     ...
     \foreach \x/\l/\p in
       { 30/{($\sqrt{3} \frac{p_x}{4}$, $\frac{p_y}{4}$)}/right,
        90/{($0$, $\frac{p_y}{2}$)}/above,
        150/{($-\sqrt{3} \frac{p_x}{4}$, $\frac{p_y}{4}$)}/left,
        210/{($-\sqrt{3} \frac{p_x}{4}$, $-\frac{p_y}{4}$)}/left,
        270/{($0$, $-\frac{p_y}{2}$)}/below,
        330/{($\sqrt{3} \frac{p_x}{4}$, $-\frac{p_y}{4}$)}/below right
       }
