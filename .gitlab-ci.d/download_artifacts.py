...
for i in range(0, len(data)):
  if data[i]['name'] == 'pkg:cc7-gcc':
    ...
    os.system("curl -O https://gitlab.cern.ch/allpix-squared/allpix-squared/-/jobs/%s/artifacts/raw/build/allpix-squared-latest_x86_64-centos7-gcc7-opt.tar.gz" % data[i]['id'] )
    break
