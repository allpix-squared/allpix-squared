...
IF(CLANG_TIDY AND CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
    ...
    IF(RUN_CLANG_TIDY)
        ...
        ADD_CUSTOM_TARGET(
            lint-diff
            COMMAND git diff --unified=0 ${TARGET_REMOTE}/${TARGET_BRANCH}... -- ":!3rdparty/*" ":!tools/root_analysis_macros/*" | ${CLANG_TIDY_DIFF}
        ...
        ADD_CUSTOM_TARGET(
            check-lint-diff
            COMMAND
                git diff --unified=0 ${TARGET_REMOTE}/${TARGET_BRANCH}... -- ":!3rdparty/*" ":!tools/root_analysis_macros/*" | ${CLANG_TIDY_DIFF}
