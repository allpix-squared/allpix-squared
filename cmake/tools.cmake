...
FUNCTION(ADD_ALLPIX_TEST TEST)
    ...
    IF(EXPRESSIONS_PASS)
        SET_PROPERTY(TEST ${TEST} PROPERTIES PASS_REGULAR_EXPRESSION "${EXPRESSIONS_PASS}")
    ENDIF()
    IF(EXPRESSIONS_FAIL)
        SET_PROPERTY(TEST ${TEST} PROPERTIES FAIL_REGULAR_EXPRESSION "${EXPRESSIONS_FAIL}")
    ENDIF()
    ...
    IF(DEPENDENCY)
        ...
        SET_PROPERTY(TEST ${TEST} PROPERTIES DEPENDS "${DEPENDENCY}")
    ENDIF()
    ...
    IF(TESTTIMEOUT)
        ...
        SET_PROPERTY(TEST ${TEST} PROPERTIES TIMEOUT_AFTER_MATCH "${TESTTIMEOUT}")
    ENDIF()
    ...
    IF(TESTLABEL)
        ...
        SET_TESTS_PROPERTIES(${TEST} PROPERTIES LABELS "${TESTLABEL}")
    ENDIF()
