...
// Get state
AllPix::State AllPix::getState() const { return state_; }

// Get managers
ConfigManager*   AllPix::getConfigManager() { return conf_mgr_.get(); }
GeometryManager* AllPix::getGeometryManager() { return geo_mgr_.get(); }
ModuleManager*   AllPix::getModuleManager() { return mod_mgr_.get(); }
Messenger*       AllPix::getMessenger() { return msg_.get(); }
