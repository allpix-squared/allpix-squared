...
void GeometryConstructionModule::run(){
    ...
    std::shared_ptr<DetectorModel> detector_model = geo_descriptions.getDetectorModel(config_.get<std::string>("detector_name", "test")); //geo_descriptions.GetDetectorsMap()[];
