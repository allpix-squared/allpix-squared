...
MicroElecPhysics::MicroElecPhysics() : G4VModularPhysicsList() {
...
void MicroElecPhysics::ConstructEM() {
    ...
    while((*particleIterator)()) {
        ...
        if(particleName == "e-") {
            ...
            // G4MicroElecElasticCorrected("e-_G4MicroElecElastic"); theMicroElecElasticProcess->SetEmModel(new
            // G4DummyModel(),1); pmanager->AddDiscreteProcess(theMicroElecElasticProcess);
