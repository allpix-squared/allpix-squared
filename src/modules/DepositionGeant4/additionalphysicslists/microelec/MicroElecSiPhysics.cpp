...
#include "MicroElecSiPhysics.hpp"
...
MicroElecSiPhysics::MicroElecSiPhysics() : G4VModularPhysicsList() {
...
void MicroElecSiPhysics::ConstructEM() {
    ...
    em_config->SetExtraEmModel("proton", "p_G4MicroElecInelastic", new G4DummyModel, "Target", 10 * GeV, 10 * TeV);
    ...
    mod = new G4MicroElecInelasticModel();
    mod->SetActivationLowEnergyLimit(50 * keV);
    em_config->SetExtraEmModel("GenericIon", "ion_G4MicroElecInelastic", mod, "Target", 0.0, 10 * GeV);
    em_config->SetExtraEmModel("GenericIon", "ion_G4MicroElecInelastic", new G4DummyModel, "Target", 10 * GeV, 10 * TeV);
