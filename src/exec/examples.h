...
public:
    ...
    void finalize() { LOG(DEBUG) << "(1) this is the end of module 1"; }
...
public:
    ...
    void receive(std::shared_ptr<TestMessageTwo> msg) { LOG(DEBUG) << "(2) received a message: " << msg->getText(); }
    ...
    void finalize() { LOG(DEBUG) << "(2) finished"; }
