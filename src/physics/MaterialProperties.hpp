...
namespace allpix {
    ...
    static std::map<SensorMaterial, double> ionization_energies = {
        ...
        {SensorMaterial::GALLIUM_NITRIDE,
         8.33e-6}, // https://etd.ohiolink.edu/apexprod/rws_etd/send_file/send?accession=osu1448405475&disposition=inline
    ...
    static std::map<SensorMaterial, double> fano_factors = {
        ...
        {SensorMaterial::GALLIUM_ARSENIDE,
         0.07}, // https://etd.ohiolink.edu/apexprod/rws_etd/send_file/send?accession=osu1448405475&disposition=inline
